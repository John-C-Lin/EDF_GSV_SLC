...
footprint_raster_list <- mclapply(filenames, load_footprint_raster,
    mc.cores = 500
)
...
measured <- observations$ch4d_ppm_ex

footprint_full_domain <- footprint_rasters
footprint_rasters <- crop(footprint_rasters, source_bbox)
...
ggsave("img/monte_carlo/source-binary-scatterplot.png", width = 6, height = 5)
...
ggsave("img/monte_carlo/source-optimized-scatterplot.png", width = 6, height = 5)
